...
# Function to input colored text
def colored_input(prompt, color=Color.RESET):
    return input(color + prompt + Color.RESET)

s = int(input('enter number araaa! : '))

# Stories
def madlib1():
    Number = colored_input('tiv gri ara',Color.BLUE)
    Measure_of_time =colored_input('item i hamar anun gri',Color.GREEN)
    Mode_of_Transportation = colored_input('Input a mode of Transportation: ')
    Adjective = str(input('Input a Adjective: '))
    Adjective2 = str(input('Input a Adjective: '))
    Noun = str(input('Input a Noun: '))
    Color = str(input('Input a Color: '))
    Part_of_the_Body = str(input('Input a Part of the Body: '))
    Verb = str(input('Input a Verb: '))
    Number2 = str(input('Input a Number: '))
    Noun2 = str(input('Input a Noun: '))
    Noun3 = str(input('Input a Noun: '))
    Part_of_the_Body2 = str(input('Input a Part of the Body: '))
    Noun4 = str(input('Input a Noun: '))
    Adjective3 = str(input('Input a Adjective: '))
    Silly_Word = str(input('Input a Silly Word: '))
